...
class AppThemes {
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    headline1: GoogleFonts.sarabun(fontSize: 26.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    headline2: GoogleFonts.sarabun(fontSize: 20.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    headline3: GoogleFonts.sarabun(fontSize: 18.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    bodyText1: GoogleFonts.sarabun(fontSize: 16.0, color: _lightTextColor),
    bodyText2: GoogleFonts.sarabun(fontSize: 14.0, color: Colors.grey),
    button: GoogleFonts.sarabun(
        fontSize: 15.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    headline6: GoogleFonts.sarabun(fontSize: 15.0, color: _lightTextColor, fontWeight: FontWeight.w600),
    subtitle1: GoogleFonts.sarabun(fontSize: 16.0, color: _lightTextColor),
    caption: GoogleFonts.sarabun(fontSize: 12.0, color: _lightBackgroundAppBarColor),
  );
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    headline1: GoogleFonts.sarabun(fontSize: 20.0, color: _darkTextColor),
    bodyText1: GoogleFonts.sarabun(fontSize: 16.0, color: _darkTextColor),
    bodyText2: GoogleFonts.sarabun(fontSize: 14.0, color: Colors.grey),
    button: GoogleFonts.sarabun(
        fontSize: 15.0, color: _darkTextColor, fontWeight: FontWeight.w600),
    headline6: GoogleFonts.sarabun(fontSize: 16.0, color: _darkTextColor),
    subtitle1: GoogleFonts.sarabun(fontSize: 16.0, color: _darkTextColor),
    caption: GoogleFonts.sarabun(fontSize: 12.0, color: _darkBackgroundAppBarColor),
  );
